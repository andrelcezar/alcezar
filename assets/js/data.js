...
window.SITE_DATA = {
  ...
  galeria: [
    /* Show da High Moonlight no evento GruTons */
    { src: "assets/images/galeria/hml-andre-baixo.webp", thumb: "assets/images/galeria/hml-andre-baixo-thumb.webp", titulo: "Grave em primeiro plano", legenda: "Com a High Moonlight no GruTons", categoria: "palco", tamanho: "alta",
      en: { titulo: "Low end up front", legenda: "With High Moonlight at GruTons" } },
    { src: "assets/images/galeria/hml-banda-palco.webp", thumb: "assets/images/galeria/hml-banda-palco-thumb.webp", titulo: "High Moonlight ao vivo", legenda: "A banda completa em ação no GruTons", categoria: "palco", tamanho: "larga",
      en: { titulo: "High Moonlight live", legenda: "The full band in action at GruTons" } },
    { src: "assets/images/galeria/hml-ao-vivo.webp", thumb: "assets/images/galeria/hml-ao-vivo-thumb.webp", titulo: "Energia de palco", legenda: "Show da High Moonlight no GruTons", categoria: "palco", tamanho: "alta",
      en: { titulo: "Stage energy", legenda: "High Moonlight live at GruTons" } },
    { src: "assets/images/galeria/hml-palco-completo.webp", thumb: "assets/images/galeria/hml-palco-completo-thumb.webp", titulo: "Palco HML", legenda: "A banda sob o logo da HML no GruTons", categoria: "palco", tamanho: "alta",
      en: { titulo: "HML stage", legenda: "The band under the HML logo at GruTons" } },
    { src: "assets/images/galeria/hml-teatro.webp", thumb: "assets/images/galeria/hml-teatro-thumb.webp", titulo: "Do fundo da plateia", legenda: "O palco do GruTons visto da plateia", categoria: "palco", tamanho: "larga",
      en: { titulo: "From the back of the room", legenda: "The GruTons stage from the audience" } },
